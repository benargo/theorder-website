...
use App\Blizzard\Service as BaseService;
...
class Service extends BaseService
{
     ...
     */
    public function getAchievement($achievement_id, array $options = [])
    {
        return $this->request('/achievement/'.(int) $achievement_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getBoss($boss_id, array $options = [])
    {
        return $this->request('/boss/'.(int) $boss_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getCharacter($realm, $character_name, array $options = [])
    {
        return $this->request('/character/'.(string) $realm.'/'.(string) $character_name, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getGuild($realm, $guild_game, array $options = [])
    {
        return $this->request('/guild/'.(string) $realm.'/'.(string) $guild_game, $options);
    }
    ...
    {
        return $this->request('/item/'.(int) $item_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getItemSet($set_id, array $options = [])
    {
     ...
     * @return ResponseInterface
     */
    public function getPetAbility($ability_d, array $options = [])
    {
        return $this->request('/pet/ability/'.(int) $ability_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getPetSpecies($species_id, array $options = [])
    {
        return $this->request('/pet/species/'.(int) $species_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getPetStats($species_d, array $options = [])
    {
        return $this->request('/pet/stats/'.(int) $species_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getQuest($quest_id, array $options = [])
    {
        return $this->request('/quest/'.(int) $quest_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getRecipe($recipe_id, array $options = [])
    {
        return $this->request('/recipe/'.(int) $recipe_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getSpell($spell_id, array $options = [])
    {
        return $this->request('/spell/'.(int) $spell_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getZone($zone_id, array $options = [])
    {
        return $this->request('/zone/'.(int) $zone_id, $options);
    }
     ...
     * @return ResponseInterface
     */
    public function getProfileCharacters($access_token = null, array $options = [])
    {
        if (null === $access_token) {
            $options['access_token'] = $this->blizzard_client->getAccessToken();
        } else {
