                    ...
                    <tbody>
                        <tr :id="'rank' + index" v-for="(r, index) in ranks" @focusout="saveRow(index)">
                            ...
                            <td class="align-top">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" :title="lang.btnEdit" v-else @click="editRow(index)">
                                    <font-awesome-icon :icon="['fas', 'pencil']"></font-awesome-icon>
                                    <span class="sr-only">{{ lang.btnEdit }}</span>
                                </button>
                                <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" :title="lang.btnDelete" @click="deleteRank(r.id)">
