            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <div class="race-icons">
                        <img src="/images/raceicons.png"
                            :alt="r.name"
                            :class="raceIconClass(r.name)"
                            data-html="true"
                            data-toggle="tooltip"
                            data-placement="bottom"
                            :title="r.name"
                            v-for="r in races"
                            @click="handleIcon('race', r)"
                        />
                    </div>
                ...
                <div class="form-group col">
                    ...
                    <div class="class-icons">
                        <img src="/images/classicons.png"
                            :alt="c.name"
                            :class="classIconClass(c.name)"
                            data-html="true"
                            data-toggle="tooltip"
                            data-placement="bottom"
                            :title="c.name"
                            v-for="c in classes"
                            @click="handleIcon('class', c)"
                        />
                    </div>
