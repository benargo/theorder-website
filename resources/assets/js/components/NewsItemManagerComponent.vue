    ...
    <div class="row" v-if="last_page > 1">
        <div class="col-12 text-center">
            <div class="btn-group">
                ...
                <button class="btn btn-primary btn-lg" :class="(page == current_page ? 'active' : '')" :aria-pressed="(page == current_page)" @click="fetchItems(path + '?page=' + page)" v-for="page in last_page">{{ page }}</button>
