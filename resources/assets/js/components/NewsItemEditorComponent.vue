                    ...
                    <form class="needs-validation" id="formPublishDate" novalidate>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="inputPublishDate" v-mask="'99/99/9999 99:99'" v-model="publishDate" aria-describedby="publishDateHelp" placeholder="__/__/____ __:__" @blur="validatePublishDate">
...
export default {
    computed: {
        compiledMarkdown: function() {
            return window.marked(this.article.body, {
                sanitize: true
            })
        },
