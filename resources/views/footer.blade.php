        ...
        <div class="row my-5">
            <div class="col col-md-6">
                <div class="text-center">
                    <a href="{{ route('homepage') }}" title="The Order">
            ...
            <div class="col col-md-6">
                <div class="text-center">
                    <a href="https://worldofwarcraft.com/wowclassic" title="World of Warcraft Classic">
                        <img class="img-fluid max-height-150" src="{{ asset('images/wow_classic_logo.png') }}" alt="World of Warcraft Classic logo" height="100" />
