...
<html lang="en">
    ...
    <body class="antialiased font-sans bg-brown-texture">
        <div class="md:flex min-h-screen">
            <div class="w-full md:w-1/2 flex items-center justify-center">
                <div class="max-w-sm m-8">
                    ...
                    <p class="text-muted text-2xl md:text-3xl font-light mb-8 leading-normal">
                        @yield('message')
                    </p>
            ...
            <div class="relative bg-goblin-engineer pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
                @yield('image')
            </div>
        </div>
    </body>
